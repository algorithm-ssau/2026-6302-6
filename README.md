...
## Что это
Прикладное приложение на базе российской LLM GigaChat, которое генерирует тесты и самари на основе текстовых документов различных форматов
...
## Вклад участников
- Цвилий Иван - дизайн и UI
- Хаперский Кирилл - подключение к LLM, отправка ей запросов и парсинг ответов
- Мартынов Егор - соединение модуля с UI и модуля работы с LLM, внутренняя логика работы 
